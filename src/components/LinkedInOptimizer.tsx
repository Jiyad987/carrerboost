      ...
      >
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-[#0077B5] text-white px-4 py-2 rounded-lg mb-4">
            ...
            <span className="font-semibold">LinkedIn Optimization Suite</span>
          </div>
          <h2 className="text-4xl font-bold mb-4">Optimize Your LinkedIn Presence</h2>
          <p className="text-muted-foreground">Profile optimization, content creation, and growth strategies</p>
        </div>

        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-8">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="optimizer">Profile Optimizer</TabsTrigger>
            <TabsTrigger value="content">Content Builder</TabsTrigger>
            <TabsTrigger value="tips">Growth Tips</TabsTrigger>
          </TabsList>
