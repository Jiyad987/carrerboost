          ...
          <Card className="p-6 sm:p-8 shadow-lg text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                variant="outline"
                size="lg"
                onClick={() => window.location.href = "mailto:sayedmuhammedjiyad@gmail.com?subject=Career%20Support%20Inquiry&body=Hi%20FixMyCareer.in%2C%20I%20need%20help%20with%20my%20career."}
              >
